...
public class MessagesActivity extends AppCompatActivity implements
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (finalMessage != null) {
                Toast.makeText(MessagesActivity.this, finalMessage, Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    MessagesMenu messagesFragment = new MessagesMenu();
                    return messagesFragment;
                case 2:
                    Locations locationsFragment = new Locations();
    ...
    public void onPeersAvailable(SimWifiP2pDeviceList peers) {
        ...
        new AlertDialog.Builder(this).setTitle("Devices in WiFi Range").setMessage(peersStr.toString()).setNeutralButton("Dismiss", new DialogInterface.OnClickListener() {
